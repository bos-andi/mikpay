...
// get variable
  ...
  $pageppp = array('secrets','profiles','active','billing');
  ...
  // If subscription expired and not on subscription page, redirect
  if (!$isSubscriptionActive && $id != "subscription") {
    header("Location: ./?id=subscription&session=" . $session);
    exit;
  }
