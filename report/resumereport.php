...
.resume-total-card h4 { margin: 0; font-size: 14px; opacity: 0.9; }
.resume-total-card p { margin: 5px 0 0; font-size: 28px; font-weight: 700; }
</style>

<div class="card">
    <div class="card-header">
        <h3><i class="fa fa-area-chart"></i> Resume Report - <?= ucfirst($thisM)." ".$thisY;?></h3>
    </div>
    <div class="card-body" style="padding: 20px;">
        
        <!-- Total Card -->
        <div class="resume-total-card">
            <div>
                <h4>Resume Report <?= ucfirst($thisM)." ".$thisY;?></h4>
                <p><?= $totalvrc ?> Transaksi</p>
            </div>
            <div style="text-align:right;">
                <h4>Total Income</h4>
                <p><?= $currency ?> <?= number_format((float)$totalincome, 0, ",", ".") ?></p>
            </div>
        </div>
        ...
        <div id="container" style="border-radius: 10px; overflow: hidden;"></div>
