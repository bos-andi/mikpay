...
if($getsprice == "1000"){ $color = "#666";} // jika harga == "1000" maka warna = "#01579B"
elseif($getsprice == "2000"){ $color = "#00F31A";}
elseif($getsprice == "3000"){ $color = "#0438E8";}
elseif($getsprice == "4000"){ $color = "#FA7207";}
...
<img style="margin:0px 30% 0 0px;" width="80" height="20" src="<?php echo $logo;?>" alt="logo">
<span id="num" style="margin:0px 40% 0 0px; font-size:10px; line-height: 2px;"><?= " [$num]"; ?></span>
</td>	
...
<?php if($v_opsi=='up'){ ?>
<?php }else{ ?>
							<div style="padding:0px;border-bottom:1px solid<?php echo $color ?>;text-align:center;font-weight:bold;font-size:8px;">VOUCHER</div>
							<div style="padding:0px;border-bottom:1px solid<?php echo $color ?>;text-align:center;font-weight:bold;font-size:12px;;color:#000000;"><?php echo $username;?></div>
<?php } ?>
						</div>
<div style="text-align:justify;color:#111;font-size:6px;font-weight:bold;margin:0px;padding:2.5px;">
Hubungkan ke WiFi Voucher
Buka browser ketik : an.net atau scan kode disamping setelah terhubung jaringan
</div>
</td>	
